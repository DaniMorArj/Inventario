...
$rol = $_SESSION['rol'];// Obtenemos el rol del usuario para mostrar el menú correspondiente
...
// Submenú Oficina
$submenuOficina = true;
$activeSubmenuOficina = ''; // ejemplo: 'alta_trabajador'
...
//Paginación - Calculamos el total de páginas y el inicio para la consulta
$porPagina = 8;
$pagina = 1;
